...
def make_derived_name(name: str, subtype: str, suffix: Optional[str] = None) -> str:
...
def get_name_side(name: str) -> Side:
    return Side.from_parts(split_name(name))


def get_name_side_z(name: str) -> SideZ:
...
def mirror_name_z(name: str) -> str:
    parts = split_name(name)
...
def unique_name(collection, base_name: str) -> str:
