...
from bpy.types import (
    bpy_struct, ID, Object, AnimData, Driver, DriverTarget, 
    FCurve, FModifierGenerator, ArmatureConstraint, Constraint, 
    PoseBone, bpy_prop_collection,
    Material,
)
...
def make_driver(
        owner: bpy_struct, prop: str, *, index=-1, type='SUM',
...
def driver_var_transform(
        target: ID, bone: Optional[str] = None, *,
...
def copy_custom_properties(
        src, dest, *, prefix='', dest_prefix='',
        link_driver=False, overridable=True
