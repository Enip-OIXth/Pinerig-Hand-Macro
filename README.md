...
Install it like any other addon/extension.
...
* **Fingers are bent in funny ways after playing with the hand macro.**
Either you haven't set the correct flexion axis, or one of your fingers needs to have it's roll tweaked in edit mode.

* **How do I tweak poses?**
You change your timeline to a Dope sheet, set the editor to Action editor and then you'll find actions in the action dropdown. Final poses are set at frame 10.You can also set intermediate keyframes anywhere between 1 and 10 (don't touch 0). Be sure to close the action and reset bone transforms with Alt+R once you've finished.

* **What is pairing?** 
Pairing hands allows you to generate multiple macros in a single generate call. Actions will also be shared between all hands that are paired.
